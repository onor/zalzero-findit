 ...
 * OnDemand</a>.
 * 
 * This test also includes the <a href="">Sauce JUnit</a> helper classes, which
 * will use the Sauce REST API to mark the Sauce Job as passed/failed.
 * 
 * In order to use the {@link SauceOnDemandTestWatcher}, the test must implement
 * the {@link SauceOnDemandSessionIdProvider} interface.
 * 
 * @author Ross Rowe
 */
public class WebDriverWithHelperTest implements SauceOnDemandSessionIdProvider {
	...
	public SauceOnDemandAuthentication authentication = new SauceOnDemandAuthentication(
			"cloudbees_zalzero", "15b88203-7a0f-4339-804a-fffb6abb2e3c");
	...
	/**
	 * JUnit Rule which will record the test name of the current test. This is
	 * referenced when creating the {@link DesiredCapabilities}, so that the
	 * Sauce Job is created with the test name.
	 */
	public @Rule
	...
	public void unionMonitorProd() {
		...
		try {
			WebElement popup_wrapper = driver.findElement(By
			...
			WebElement left_button = start_popup.findElement(By
		...
		try {
			WebElement score_friendpopup = driver.findElement(By
		...
		try {
			WebElement rating_popup = driver.findElement(By
		...
		WebElement userAreaName = userArea
				.findElement(By.id("currentUserName"));
		...
		WebElement rightHUD_yourturn = rightHUD.findElement(By
				.id("rightHUD-yourturn"));

		try {
			WebElement userArea1 = rightHUD_yourturn.findElement(By
					.className("userArea"));
			...
			WebElement friendlist = driver.findElement(By
			...
			rightHUD_yourturn = rightHUD
					.findElement(By.id("rightHUD-yourturn"));

			WebElement userArea2 = rightHUD_yourturn.findElement(By
					.className("userArea"));
