...
import com.zalerio.config.VerifyScreens;

public class NewUserEntersZalerioTest {
	//new user entering Zalerio for 1st time
	@Test
	public void joinNewUserTest()
	{//izgaimx_alisonescu_1350910201@tfbnw.net
		//userid::pieqtfw_goldmanmanskyescuwitzsonsenbergstein_1350910207@tfbnw.net
		//password::zalerio
	//	WebDriver driver= new FirefoxDriver();
		...
		left_button.click();
		VerifyScreens.verifyIngameScreenFirstTimeEnter(driver);
	}
