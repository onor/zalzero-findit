...
var acceptInvitationAdd, declineInvitationAdd, drawRoundsPanel, flag_roundBetsDrawn, flag_roundDrawn, gameChangeListener, isDevEnvironment, messagePopup, popupMSG, rematchCall, remindUserAdd, resignStatus, roundVOsIdxRightHUD, sendDeclinedToServer, showRoundScorePopup, usersRecord, __hasProp_, _currentRoundStatus;
...
jQuery(function() {
  ...
  OloChatComponent = (function() {
    ...
    sendMessageToRoomFn = function(event) {
      ...
      if (msg != null) {
        jDocument.trigger(zzEvents.SEND_UPC_MESSAGE, [UPC.SEND_MESSAGE_TO_ROOMS, "CHAT_MESSAGE", roomID, "true", "", msg]);
      }
      chatInput.value = "";
    ...
    jQuery(function() {
      ...
      return jDocument.bind(zzEvents.CLIENT_LEFT, userSignedOutMessage);
    });
    return OloChatComponent;
  })();
  sendChatMessage = function() {
    return jDocument.trigger(zzEvents.SEND_CHAT_MESSAGE);
  };
  ...
  ZalerioGame = (function() {
    ...
    initBoard = function() {
      var boardDimension;
      if (isDevEnvironment) {
        console.log("BoardXY : " + zzGlobals.roomVars[zzGlobals.roomCodes.BOARD_XY]);
      }
    ...
    initRoundBets = function() {
      if (isDevEnvironment) {
        console.log("Round Bets : " + zzGlobals.roomVars[zzGlobals.roomCodes.ROUND_NOOFBETS]);
      }
    ...
    parseRounds = function(el, val) {
      var i, obj;
      if (isDevEnvironment) {
        console.log("parse Ar data : " + zzGlobals.roomVars[zzGlobals.roomCodes.ROOM_ALLROUNDS]);
      }
    ...
    messageListener = function(event, messageName, broadcastType, fromClientID, roomID, message) {
      ...
      switch (messageName) {
        ...
        case zalerioCMDListners.RIGHT_HUD:
          ...
          if (isDevEnvironment) {
            console.log('MT', zzGlobals.msgVars.RH);
          }
      ...
      jQuery("#gamewall").delegate(".box-previousRoundOtherPlayer,.box-previousRoundCurrentPlayerIncorrect,.box-previousRoundCurrentPlayerCorrect,.box-dizitCompleted,.joker,.superJoker", "mouseover mouseout", function(e) {
        ...
        if (e.type === "mouseover" && !isMousingOver) {
          ...
          if (boardVOs[tileIdx] != null) {
            ...
            for (playerSeatId in playersObjs) {
              if (isDevEnvironment) {
                console.log("mouseover", zzGlobals.userVOsSeatIndex[playerSeatId].UR);
              }
  ...
  changeTotalUserCount = function() {
    if ((typeof docElems !== "undefined" && docElems !== null) && (docElems["totalPlayers"] != null)) {
      return docElems["totalPlayers"].innerHTML = zzGlobals.roomVars[zzGlobals.roomCodes.USER_TOTAL];
    }
  };
  changeActiveUserCount = function() {
    if ((typeof docElems !== "undefined" && docElems !== null) && (docElems["totalOnlinePlayers"] != null)) {
      return docElems["totalOnlinePlayers"].innerHTML = zzGlobals.roomVars[zzGlobals.roomCodes.USER_COUNT];
    }
  };
  ...
  jQuery(function() {
    ...
    return jDocument.bind("room:" + zzGlobals.roomCodes.USER_COUNT, changeActiveUserCount);
  });
  OloClockComponent = (function() {
    ...
    jQuery(function() {
      ...
      return jDocument.bind(zzEvents.UPDATE_LOCAL_TTL, updateClock);
    });
  ...
  ZalerioUserComponent = (function() {
    ...
    changeWinner = function() {
      if (zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_NAME] === "-1") {
        return docElems["currentWinnerName"].innerHTML = "";
      } else {
        if (docElems != null) {
          if ((docElems["currentWinnerImage"] != null) && (zzGlobals.userVOsPartyIndex[zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_ID]] != null)) {
            if (zzGlobals.userVOsPartyIndex[zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_ID]][zzGlobals.clientCodes.USER_FACEBOOK_ID] && zzGlobals.userVOsPartyIndex[zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_ID]][zzGlobals.clientCodes.USER_FACEBOOK_ID] !== "-1") {
              return docElems["currentWinnerImage"].setAttribute("src", "https://graph.facebook.com/" + zzGlobals.userVOsPartyIndex[zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_ID]][zzGlobals.clientCodes.USER_FACEBOOK_ID] + "/picture");
            } else {
            ...
            if (docElems["currentWinnerName"] != null) {
              return docElems["currentWinnerName"].innerHTML = zzGlobals.roomVars[zzGlobals.roomCodes.WINNER_NAME];
            }
          }
        }
      }
    ...
    jQuery(function() {
      ...
      return jDocument.bind("client:" + zzGlobals.clientCodes.USERINFO, updatePlayerPlate);
    });
  ...
  rematchCall = function(e, rematchPlayerFBID) {
    ...
    if (typeof rematchPlayerFBID === "undefined") {
      usersObject = jQuery.parseJSON(zzGlobals.roomVars.AP);
      if (isDevEnvironment) {
        console.log("Score Board left (zzGlobals.roomVars.AP", userObject);
      }
