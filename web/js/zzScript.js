...
define('rightHudController',["../../config/config", "../../helper/sound"], function(config, sound) {
  var createGameDetailsPopup, updateRightHud;
...
define('../../popup/roundScorePopup',[], function() {
  ...
  showRoundScorePopup = function() {
    var index, rankHtml, scorePopup, scorePopuptopthree, seatId, selfHtml, userCount, usersObject, _currentRoundStatus;
    if (parseInt(zzGlobals.roomVars.CR.split("_")[1], 10) === 0 || zzGlobals.roomVars.FR === "1") {
      return;
    }
...
define('gameEventManager',["../../config/config", "../../helper/confirmBox", "../../config/globals", "./carouselView", "./rightHudController", "./leftHudController", "./gamePlayController", "../../popup/resignPopup", "../../popup/showInviteStatus", "../../popup/showFinalScore", "../../popup/showFrndSelector", "../../helper/utils", "../../popup/roundScorePopup"], function(config, confirmBox, globals, carouselView, rightHudController, leftHudController, gamePlayController, resignPopup, showInviteStatus, showFinalScore, showFrndSelector, utils, roundScorePopup) {
