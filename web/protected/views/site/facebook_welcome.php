...
<head>
	...
	$.fx.step. backgroundPosition = function(fx) {
        ...
        <style type="text/css">
           body{
                margin: 0 auto;
                background:#111 url(<?php echo Yii::app()->request->baseUrl ?>/images/Ifnotapprovedlandingpage.jpg) center top no-repeat;
                text-align: center;
            }
            div{
...
<script>
  ...
  (function(d){
    ...
    <body>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/images/Ifnotapprovedlandingpage.jpg" style="display:none" />
        <div class="con">
          <div class="innercon">   
            <div id="head">
                <!-- image remove -->
            ...
            <div id="mid">
<!--                <div class="girl">
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0001.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0002.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0003.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0004.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0005.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0006.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0007.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0008.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0009.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0010.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0011.png" />
                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/girl_animation_sprite/ani0012.png" />
                </div>
                <div class="login">
