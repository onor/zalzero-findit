<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_fbid')); ?>:</b>
	<?php echo CHtml::encode($data->user_fbid); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_handle')); ?>:</b>
	<?php echo CHtml::encode($data->user_handle); ?>
	<br />
