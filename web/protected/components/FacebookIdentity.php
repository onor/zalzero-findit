...
class FacebookIdentity extends CUserIdentity
{
	...
	/**
	 * Authenticates a Facebook user and set session
	 */
	public function authenticate()
	{
		$auth=Yii::app()->authManager;
		
		//$this->username has user facebook id.
		//TODO: Create class variable for facebook id
		$users = Zzuser::model()->findByAttributes(array('user_fbid'=>$this->username));
